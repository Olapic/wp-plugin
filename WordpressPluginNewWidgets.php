...
USAGE: [olapic data_tags ='' data_instance = '' data_apikey='']
*/
...
function olapic_function($atts) {
  ...
  $olapic_output = '<div id="olapic_specific_widget"></div><script type="text/javascript" src="//photorankstatics-a.akamaihd.net/81b03e40475846d5883661ff57b34ece/static/frontend/latest/build.min.js"  data-olapic="olapic_specific_widget" '.$data_instance.$data_apikey.$data_tags.'async="async"></script>';
